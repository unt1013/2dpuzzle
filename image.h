...
public:
	...
	void frameInsideRender(HDC hdc, int destX, int destY, int subtractX, int subtractY);
	void frameInsideRender(HDC hdc, int destX, int destY, int currentFrameX, int currentFrameY, int subtractX, int subtractY);
